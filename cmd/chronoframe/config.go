...
const (
	...
	// `pnpm --dir web generate` writes the static client to this directory. Keep the
	// environment override for deployments that serve a separately copied
	// bundle.
	defaultWebDir = "./web/.output/public"
...
func loadConfig() Config {
	...
	return Config{
		...
		NominatimURL:       env("NUXT_NOMINATIM_BASE_URL", "https://nominatim.openstreetmap.org"),
		GithubClientID:     env("NUXT_OAUTH_GITHUB_CLIENT_ID", ""),
		GithubClientSecret: env("NUXT_OAUTH_GITHUB_CLIENT_SECRET", ""),
