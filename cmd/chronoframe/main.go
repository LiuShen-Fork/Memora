...
func main() {
	...
	app.startWorkers()
	// Clean up stale files generated by older Live Photo detection logic in
	// the background so startup and the first HTTP request stay responsive.
	go app.cleanupInvalidGeneratedVideos()
