...
func (a *App) migrateEnvironmentSettings() {
	migrations := []struct {
		...
		{"map", "amap.key", "NUXT_PUBLIC_MAP_AMAP_KEY", ""},
		{"map", "amap.securityCode", "NUXT_PUBLIC_MAP_AMAP_SECURITY_CODE", ""},
		{"location", "provider", "NUXT_LOCATION_PROVIDER", "nominatim"},
		{"location", "amap.key", "NUXT_LOCATION_AMAP_KEY", ""},
