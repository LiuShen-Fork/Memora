...
Memora supports two types of map providers. You can choose the one that best fits your needs.
...
```bash
# Memora comes with built-in light and dark styles that switch automatically.
